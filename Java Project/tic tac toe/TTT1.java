...
TTT1(){
super("TIC-TAC-TOE BY ABHISHEK");

CheckboxGroup cbg=new CheckboxGroup();
l3 = new JLabel("HELLO! WELCOME TO TIC-TAC-GO.\n KINDLY CHOOSE YOUR ACTION BELOW");
...
for(i=0;i<=7;i++){
  ...
  Icon icon3=b[(a[i][3]-1)].getIcon();
	...
	JOptionPane.showMessageDialog(TTT1.this,"!!!YOU WON!...CONGRATULATIONS!!! click reset");			 break;
                   }
             else if(icon1==ic2){
             b[(a[i][1]-1)].setIcon(ic22);
             b[(a[i][2]-1)].setIcon(ic22);
             b[(a[i][3]-1)].setIcon(ic22); 
               JOptionPane.showMessageDialog(TTT1.this,"!!!OHH!...SORRY YOU LOST!!! click reset");
                break;			 
               }
         }
    }  
